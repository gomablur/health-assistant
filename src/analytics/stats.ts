...
/**
 * 7日移動平均を表示ウィンドウの先頭から正しく出すために、ウィンドウより
 * 余分に取得すべき日数。助走なしでウィンドウ内だけで平均すると、先頭6日は
 * 参照できる日数が足りず、同じ日の平均値が表示期間(30日/90日など)によって
 * ズレてしまう。取得を +6日し、`lastDays` でウィンドウに切り出して使う。
 */
export const MA_LEAD_DAYS = 6;
